    ...
    $.each(myProject, function (i, value) {
        ...
        var html = ' <div class="col-sm-4 py-2">\
          ...
          <div id="slide'+ i + '" class="carousel slide" data-bs-ride="carousel">\
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#slide'+ i + '" data-bs-slide="prev">\
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>\
              <span class="visually-hidden">Previous</span>\
            </button>\
            <button class="carousel-control-next" type="button" data-bs-target="#slide'+ i + '" data-bs-slide="next">\
